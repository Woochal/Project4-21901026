...
<body>
    ...
    <div id="formdiv" class="container">
        <form action="form_ok.jsp" method="post" class="needs-validation" name="hotel" onsubmit="return validationCheck()"  novalidate>
            <div class="row mb-5">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="guest" id="guest" class="form-control" required>
